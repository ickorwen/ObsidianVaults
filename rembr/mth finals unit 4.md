...
- **Interval/Ratio Level:**
  - Rate pain on a 0–10 numerical scale.
...
- **Mean (𝑥̄)**: The arithmetic average of observed values.
- **Median (𝑥̃)**: The middle value when observations are arranged in order.
- **Mode (𝑥̄)**: The most frequently observed value in a dataset.
--- 
### Mean
- **Arithmetic Mean**: “center of gravity” of the data set
  - **Ungrouped Data**:
